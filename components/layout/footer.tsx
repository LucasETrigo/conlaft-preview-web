...
export function Footer() {
    ...
    const footerSections = [
        ...
        },
        {
            title: 'Software',
            links: [
                { label: 'Contadores', href: '/software/contadores' },
                { label: 'Cooperativas', href: '/software/cooperativas' },
                { label: 'Fideicomisos', href: '/software/fideicomisos' },
                { label: 'Mutuales', href: '/software/mutuales' },
                { label: 'Juegos de Azar', href: '/software/juegosdeazar' },
                { label: 'SAC', href: '/software/SAC' },
            ],
        },
        {
            title: 'Recursos',
