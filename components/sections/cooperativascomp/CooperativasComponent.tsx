...
import CardHoverCooperativas from './CardHoverCooperativas';

const CooperativasComponent = () => {
    return (
        <div className='container mx-auto px-6 pt-28 sm:pt-36 md:pt-44 space-y-12 pb-16 text-center'>
            ...
            <h1 className='text-4xl font-extrabold text-gray-900 leading-tight'>
                ...
                <span className='text-indigo-600'>LAVADO DE DINERO</span> y{' '}
            ...
            <p className='mt-6 text-gray-600 leading-relaxed text-lg max-w-7xl mx-auto'>
                ...
                cooperativas a cumplir con la Resolución 99/2023 de la UIF,
            ...
            <CardHoverCooperativas />
        </div>
    );
};

export default CooperativasComponent;
