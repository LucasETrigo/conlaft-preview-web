...
export const projects = [
    {
        title: 'Clientes',
        description:
            'El registro contiene datos completos de personas, empresas y entidades públicas, y los contratos vinculados a la empresa. Los datos están encriptados para garantizar su confidencialidad.',
        link: '#',
    },
    {
        title: 'Calificaciones',
        description:
            'El sistema permite parametrizar la proporción del ingreso que el cliente puede operar dentro de la empresa.',
        link: '#',
    },
    {
